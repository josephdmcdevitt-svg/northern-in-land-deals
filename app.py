...
COUNTIES = {
    ...
    # ══════ SW MICHIGAN — border counties ══════
    "Berrien (MI)":    {"avg":11800,"lo":7000,"hi":18000,"seat":"St. Joseph",  "pop":153401,"listings_est":909,"nccpi":64,"farm_pct":55,"forest_pct":22,"corn_yield":172,"soy_yield":54,"wheat_yield":71,"rent":260,"hist":[9100,9700,10400,11100,11600,11800],"top_soil":"Oshtemo sandy loam, Spinks loamy sand","cattle_stocking":1.9,"timber_val":1600,"top_crops":["Grapes/Wine","Fruit","Corn","Soybeans"]},
    "Cass (MI)":       {"avg":10500,"lo":6500,"hi":14500,"seat":"Cassopolis",  "pop":51589, "listings_est":207,"nccpi":61,"farm_pct":58,"forest_pct":24,"corn_yield":168,"soy_yield":53,"wheat_yield":68,"rent":245,"hist":[8100,8700,9300,9900,10300,10500],"top_soil":"Oshtemo sandy loam","cattle_stocking":2.0,"timber_val":1500,"top_crops":["Corn","Soybeans","Hay","Livestock"]},
    "St. Joseph (MI)": {"avg":11000,"lo":7000,"hi":15000,"seat":"Centreville", "pop":60964, "listings_est":180,"nccpi":63,"farm_pct":62,"forest_pct":20,"corn_yield":172,"soy_yield":54,"wheat_yield":70,"rent":255,"hist":[8500,9100,9700,10300,10800,11000],"top_soil":"Oshtemo-Spinks complex","cattle_stocking":1.9,"timber_val":1400,"top_crops":["Corn","Soybeans","Seed Corn","Mint"]},
    "Branch (MI)":     {"avg":9800, "lo":6200,"hi":13500,"seat":"Coldwater",   "pop":43540, "listings_est":240,"nccpi":60,"farm_pct":60,"forest_pct":22,"corn_yield":165,"soy_yield":52,"wheat_yield":67,"rent":240,"hist":[7500,8000,8600,9200,9600,9800],"top_soil":"Miami-Crosby complex","cattle_stocking":2.0,"timber_val":1400,"top_crops":["Corn","Soybeans","Dairy","Hay"]},
    "Van Buren (MI)":  {"avg":10800,"lo":6800,"hi":15500,"seat":"Paw Paw",     "pop":75587, "listings_est":350,"nccpi":60,"farm_pct":50,"forest_pct":28,"corn_yield":168,"soy_yield":53,"wheat_yield":68,"rent":250,"hist":[8300,8900,9500,10100,10500,10800],"top_soil":"Oshtemo sandy loam","cattle_stocking":1.9,"timber_val":1500,"top_crops":["Grapes/Wine","Blueberries","Corn","Soybeans"]},
}
...
SEED_LISTINGS = [
    ...
    # ═══════ SW MICHIGAN (border counties) — scraped 4/10/2026 ═══════
    # ── Berrien County, MI ──
    {"title": "96.6 Ac w/ 60x80 Pole Barn — Gardner Rd", "location": "Berrien County", "county": "Berrien (MI)", "acres": 96.6, "price": 885000, "price_per_acre": 9157, "listing_type": "For Sale", "property_type": "Recreational/Hunting", "source": "Mossy Oak Properties", "url": "https://www.mossyoakproperties.com/land-for-sale/michigan/berrien-county/", "auction_date": None, "tags": ["hunting", "pole-barn", "mi-border"], "why": "Below avg $/ac for Berrien. 60x80 finished pole barn = built-in value.", "is_new": False},
    {"title": "51.45 Ac Tillable — North Berrien State Line", "location": "Berrien County", "county": "Berrien (MI)", "acres": 51.45, "price": 740880, "price_per_acre": 14391, "listing_type": "For Sale", "property_type": "Farmland", "source": "Mossy Oak Properties", "url": "https://www.mossyoakproperties.com/land-for-sale/michigan/berrien-county/", "auction_date": None, "tags": ["tillable", "us-31", "growth-path"], "why": "Visible from US 31. In growth path. High-performing tillable.", "is_new": False},
    {"title": "70 Ac Mixed Wooded + Tillable — Broceus Rd", "location": "Berrien County", "county": "Berrien (MI)", "acres": 70, "price": 612500, "price_per_acre": 8750, "listing_type": "For Sale", "property_type": "Mixed Use", "source": "Mossy Oak Properties", "url": "https://www.mossyoakproperties.com/land-for-sale/michigan/berrien-county/", "auction_date": None, "tags": ["wooded", "tillable", "seller-financing", "st-joseph-river"], "why": "Seller financing available! West of St. Joseph River. Rare MI land deal.", "is_new": False},
    {"title": "50 Ac Portage Rd — Hunting + Farm Income", "location": "Berrien County", "county": "Berrien (MI)", "acres": 50, "price": 600000, "price_per_acre": 12000, "listing_type": "For Sale", "property_type": "Recreational/Farmland", "source": "Mossy Oak Properties", "url": "https://www.mossyoakproperties.com/land-for-sale/michigan/berrien-county/", "auction_date": None, "tags": ["hunting", "farmland", "income"], "why": "Income-producing farmland + hunting. Dual-use deal.", "is_new": False},
    {"title": "21 Ac Mixed-Use Farm — Mount Tabor Rd", "location": "Berrien County", "county": "Berrien (MI)", "acres": 21, "price": 835000, "price_per_acre": 39762, "listing_type": "For Sale", "property_type": "Residential/Commercial/Ag", "source": "Mossy Oak Properties", "url": "https://www.mossyoakproperties.com/land-for-sale/michigan/berrien-county/", "auction_date": None, "tags": ["mixed-use", "residential", "commercial"], "why": "Mixed residential + commercial + ag blend. Premium location.", "is_new": False},
    {"title": "40 Ac St. Joseph Riverfront", "location": "Berrien County", "county": "Berrien (MI)", "acres": 40, "price": None, "price_per_acre": None, "listing_type": "For Sale", "property_type": "Riverfront", "source": "LandWatch", "url": "https://www.landwatch.com/michigan-land-for-sale/berrien-county", "auction_date": None, "tags": ["riverfront", "st-joseph-river", "hunting"], "why": "Over 1/2 mile of St. Joseph River frontage. 20 cleared, 20 wooded.", "is_new": False},
    {"title": "New Buffalo Harbor Area — 5 Ac Commercial", "location": "New Buffalo", "county": "Berrien (MI)", "acres": 5, "price": None, "price_per_acre": None, "listing_type": "For Sale", "property_type": "Commercial", "source": "LandWatch", "url": "https://www.landwatch.com/michigan-land-for-sale/berrien-county", "auction_date": None, "tags": ["new-buffalo", "harbor", "commercial"], "why": "New Buffalo is booming Chicago weekender market. Deep-water harbor town.", "is_new": False},

    # ── Cass County, MI ──
    {"title": "80 Ac Hunting Tract — Edwardsburg Area", "location": "Edwardsburg", "county": "Cass (MI)", "acres": 80, "price": 520000, "price_per_acre": 6500, "listing_type": "For Sale", "property_type": "Hunting", "source": "Michigan Whitetail Properties", "url": "https://michiganwhitetailproperties.com/michigan-land-for-sale/cass-county/", "auction_date": None, "tags": ["hunting", "wooded", "mi-border"], "why": "$6,500/ac = below Cass MI avg. Borders IN St. Joseph County.", "is_new": False},
    {"title": "120 Ac Farm/Timber — Cassopolis", "location": "Cassopolis", "county": "Cass (MI)", "acres": 120, "price": 960000, "price_per_acre": 8000, "listing_type": "For Sale", "property_type": "Farmland/Timber", "source": "Land & Farm", "url": "https://www.landandfarm.com/search/michigan/cass-county-land-for-sale/", "auction_date": None, "tags": ["farmland", "timber", "large-tract"], "why": "$8K/ac for big tract near IN border. Diamond Lake area.", "is_new": False},
    {"title": "40 Ac Diamond Lake Vicinity", "location": "Cassopolis", "county": "Cass (MI)", "acres": 40, "price": 320000, "price_per_acre": 8000, "listing_type": "For Sale", "property_type": "Recreational", "source": "LandSearch", "url": "https://www.landsearch.com/properties/cass-county-mi", "auction_date": None, "tags": ["diamond-lake", "recreational"], "why": "Near Diamond Lake — popular recreation area. 5 min to IN.", "is_new": False},
    {"title": "60 Ac Dowagiac River Frontage", "location": "Dowagiac", "county": "Cass (MI)", "acres": 60, "price": None, "price_per_acre": None, "listing_type": "For Sale", "property_type": "Recreational", "source": "Land.com", "url": "https://www.land.com/Cass-County-MI/all-land/", "auction_date": None, "tags": ["riverfront", "dowagiac", "wooded"], "why": "Dowagiac River frontage. Good steelhead fishing.", "is_new": False},

    # ── St. Joseph County, MI ──
    {"title": "88 Ac Tillable — Centreville", "location": "Centreville", "county": "St. Joseph (MI)", "acres": 88, "price": 660000, "price_per_acre": 7500, "listing_type": "For Sale", "property_type": "Farmland", "source": "Land & Farm", "url": "https://www.landandfarm.com/search/michigan/st-joseph-county-land-for-sale/", "auction_date": None, "tags": ["tillable", "mi-border", "centreville"], "why": "$7,500/ac below avg for MI county. Close to IN LaGrange border.", "is_new": False},
    {"title": "105 Ac Seed Corn Ground — Three Rivers", "location": "Three Rivers", "county": "St. Joseph (MI)", "acres": 105, "price": 987000, "price_per_acre": 9400, "listing_type": "For Sale", "property_type": "Farmland", "source": "LandWatch", "url": "https://www.landwatch.com/michigan-land-for-sale/st-joseph-county", "auction_date": None, "tags": ["tillable", "seed-corn", "three-rivers"], "why": "Seed corn production area = premium rent rates.", "is_new": False},
    {"title": "50 Ac Mixed — Sturgis Area", "location": "Sturgis", "county": "St. Joseph (MI)", "acres": 50, "price": 375000, "price_per_acre": 7500, "listing_type": "For Sale", "property_type": "Mixed Use", "source": "Land.com", "url": "https://www.land.com/property/St-Joseph-County-MI/", "auction_date": None, "tags": ["tillable", "wooded", "sturgis"], "why": "Sturgis borders LaGrange IN. $7,500/ac good value.", "is_new": False},

    # ── Branch County, MI ──
    {"title": "47 Ac Rose Lake — 1,200+ ft Shoreline", "location": "Coldwater", "county": "Branch (MI)", "acres": 47, "price": None, "price_per_acre": None, "listing_type": "For Sale", "property_type": "Lakefront/Farm", "source": "LandWatch", "url": "https://www.landwatch.com/michigan-land-for-sale/branch-county", "auction_date": None, "tags": ["lakefront", "rose-lake", "all-sports", "hobby-farm"], "why": "1,200+ ft of untouched all-sports lake shoreline. 32 ac tillable.", "is_new": False},
    {"title": "40 Ac Hunting + Tillable — Bronson", "location": "Bronson", "county": "Branch (MI)", "acres": 40, "price": 280000, "price_per_acre": 7000, "listing_type": "For Sale", "property_type": "Hunting/Farmland", "source": "Land & Farm", "url": "https://www.landandfarm.com/search/michigan/branch-county-land-for-sale/", "auction_date": None, "tags": ["hunting", "farmland", "sw-michigan"], "why": "Half prime woods + half productive farm. Prime SW Michigan hunting.", "is_new": False},
    {"title": "49 Ac Country Living — Coldwater", "location": "Coldwater", "county": "Branch (MI)", "acres": 49, "price": 392000, "price_per_acre": 8000, "listing_type": "For Sale", "property_type": "Mixed Use", "source": "LandFlip", "url": "https://www.landflip.com/land/89963", "auction_date": None, "tags": ["country-living", "income", "recreation"], "why": "Country living + income farmland + recreation. All-in-one.", "is_new": False},
    {"title": "40 Ac Hunting Paradise — Coldwater", "location": "Coldwater", "county": "Branch (MI)", "acres": 40, "price": 320000, "price_per_acre": 8000, "listing_type": "For Sale", "property_type": "Hunting/Residential", "source": "LandFlip", "url": "https://www.landflip.com/land/89963", "auction_date": None, "tags": ["hunting", "building-site", "wooded"], "why": "Cleared building spot + abundant wildlife. Ideal hunter's cabin site.", "is_new": False},
    {"title": "75 Ac Online Auction — E County Line Rd", "location": "Branch County", "county": "Branch (MI)", "acres": 75, "price": None, "price_per_acre": None, "listing_type": "Auction", "property_type": "Mixed Use", "source": "Mossy Oak Auction", "url": "https://www.mossyoakproperties.com/", "auction_date": "2026-04-23", "tags": ["auction", "online-only", "mi-border"], "why": "Online-only auction — no reserve, premier blend of features.", "is_new": False},
    {"title": "6.69 Ac Middle Lake Lakefront — Auction", "location": "Coldwater", "county": "Branch (MI)", "acres": 6.69, "price": None, "price_per_acre": None, "listing_type": "Auction", "property_type": "Lakefront", "source": "Mossy Oak Auction", "url": "https://www.mossyoakproperties.com/", "auction_date": "2026-04-16", "tags": ["lakefront", "auction", "middle-lake"], "why": "Rare lakefront auction. Middle Lake/Archer Lake waterfront.", "is_new": False},

    # ── Van Buren County, MI ──
    {"title": "60 Ac Wine Country — Paw Paw", "location": "Paw Paw", "county": "Van Buren (MI)", "acres": 60, "price": 540000, "price_per_acre": 9000, "listing_type": "For Sale", "property_type": "Agricultural/Vineyard", "source": "Land.com", "url": "https://www.land.com/Van-Buren-County-MI/all-land/", "auction_date": None, "tags": ["vineyard-potential", "wine-country", "paw-paw"], "why": "SW Michigan wine country. Vineyard-ready soil. Tourism upside.", "is_new": False},
    {"title": "40 Ac Blueberry Farm — Van Buren", "location": "Van Buren County", "county": "Van Buren (MI)", "acres": 40, "price": 450000, "price_per_acre": 11250, "listing_type": "For Sale", "property_type": "Specialty Ag", "source": "LandWatch", "url": "https://www.landwatch.com/michigan-land-for-sale/van-buren-county", "auction_date": None, "tags": ["blueberries", "specialty-crops", "high-value"], "why": "Van Buren produces 40% of MI blueberries. Premium specialty crop.", "is_new": False},
    {"title": "25 Ac Hunting + Creek — Van Buren", "location": "Van Buren County", "county": "Van Buren (MI)", "acres": 25, "price": 175000, "price_per_acre": 7000, "listing_type": "For Sale", "property_type": "Recreational", "source": "Land & Farm", "url": "https://www.landandfarm.com/search/michigan/van-buren-county-land-for-sale/", "auction_date": None, "tags": ["hunting", "creek", "wooded"], "why": "$7K/ac for wooded hunting tract with creek.", "is_new": False},

    # ── SW Michigan Tax Sales ──
    {"title": "Berrien Co MI Foreclosure Auction 2026", "location": "St. Joseph", "county": "Berrien (MI)", "acres": None, "price": None, "price_per_acre": None, "listing_type": "Tax Sale", "property_type": "Multiple Parcels", "source": "Berrien Co Treasurer", "url": "https://www.berriencounty.org/250/Treasurer", "auction_date": "2026-08-15", "tags": ["tax-sale", "foreclosure", "mi"], "why": "Michigan uses tax foreclosure auctions (no redemption after foreclosure). Deep discounts.", "is_new": False},
    {"title": "Cass Co MI Tax Foreclosure Sale", "location": "Cassopolis", "county": "Cass (MI)", "acres": None, "price": None, "price_per_acre": None, "listing_type": "Tax Sale", "property_type": "Multiple Parcels", "source": "Cass Co MI Treasurer", "url": "https://www.casscountymi.org/", "auction_date": "2026-09-10", "tags": ["tax-sale", "foreclosure", "mi"], "why": "SW Michigan tax foreclosure. Rural + lakeside parcels.", "is_new": False},
    {"title": "Branch Co MI Land Sale", "location": "Coldwater", "county": "Branch (MI)", "acres": None, "price": None, "price_per_acre": None, "listing_type": "Tax Sale", "property_type": "Multiple Parcels", "source": "Branch Co Treasurer", "url": "https://www.co.branch.mi.us/", "auction_date": "2026-08-20", "tags": ["tax-sale", "branch-mi"], "why": "Branch Co has lake properties that occasionally hit tax sale.", "is_new": False},
]
...
# HEADER
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
st.markdown("# Northern Indiana + SW Michigan Land Deals")
